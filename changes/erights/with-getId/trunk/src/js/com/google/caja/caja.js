...
(function(global) {
   ...
   * <p>
   * Otherwise, log(str) does nothing. Note: JavaScript has no macros,
   * so even in the "does nothing" case, remember that the arguments
   * are still evaluated.
   */
  ...
  /**
   * If this outers no longers needs to be accessed by
   * <tt>getOuters</tt>, then <tt>unregister</tt> it so it can be
   * garbage collected.
   * <p>
   * After unregistering, the id is not reassigned, and the outers
