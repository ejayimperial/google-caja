...
if (Function.prototype.bind === (void 0)) {
  /**
   * Bind this function object to <tt>thisObject</tt>, which will serve
...
//    fastpathSet(obj, name);
  ...
  useGetAndCallHandlers(Object.prototype, 'hasOwnProperty', 
    xo4a(function(name){
      name = String(name);
  ...
  useGetAndCallHandlers(Object.prototype, 'apply', 
    xo4a(function(that, realArgs) {
      return asXo4aFunc(this).apply(that, realArgs);
    }));
  useGetAndCallHandlers(Object.prototype, 'call', 
    xo4a(function(that, var_args) {
      var args = Array.prototype.slice.call(arguments, 1);
      return asXo4aFunc(this).apply(that, args);
    }));
  useGetAndCallHandlers(Object.prototype, 'bind', 
    xo4a(function(that, var_args) {
      var self = this;
      var args = Array.prototype.slice.call(arguments, 1);
      return primFreeze(simpleFunc(function(var_args) {
        var newArgs = Array.prototype.slice.call(arguments, 0);
        return callPub(self, 'apply', [that, args.concat(newArgs)]);
      }));
    }));
