  ...
  function loadCaja(htmlText, uiSuffix) {
    ...
    if (m) {
     ...
     // Set up the module handler
      ...
      ___.getNewModuleHandler().setOutcomeHandler(imports.yielder___);
...
var getImports = (function () {
  ...
  function yielder(uiSuffix) {
    function outcomeHandler(isSuccess, o) {
    ...
    return ___.simpleFrozenFunc(outcomeHandler);
  }
  ...
  function getImports(uiSuffix) {
    ...
    testImports.yielder___ = yielder(uiSuffix);
