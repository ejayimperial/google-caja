...
public class CajitaRewriterTest extends CommonJsRewriterTestCase {
  ...
  public void testSyntheticNestedFunctionIsExpanded() throws Exception {
    ...
    ParseTreeNode expectedResult = js(fromString(
        ...
        + "function f() {"
        + "  "  // ... not down here!
        + weldSetPub("foo.SIMPLECALL___()", "x", "bar.SIMPLECALL___()", "x0___", "x1___")
        + ";}"));
    checkSucceeds(input, expectedResult);
  }
  ...
  public void testNestedBlockWithVariable() throws Exception {
    checkSucceeds(
        ...
        weldPrelude("g") +
         "var x0___;" +
        "{" +
         "  var x = " + weldReadPub("g.SIMPLECALL___()", "y", "x0___") + ";"+
         "}");
  }
  ...
  public void testReadPublic() throws Exception {
    checkSucceeds(
        ...
        "var x0___;" +
        "var p;" +
        "p = " + weldReadPub("foo.SIMPLECALL___()", "p", "x0___") + ";");
  }
  ...
  public void testSetPublic() throws Exception {
    checkSucceeds(
        ...
        "var x0___;" +
        "var x1___;" +
        weldSetPub("x.SIMPLECALL___()", "p", "___.readPub(g, 0)", "x0___", "x1___") +
        ";");
  }
  ...
  public void testDeletePub() throws Exception {
    ...
    checkSucceeds(
        ...
        weldPrelude("bar") +
        weldPrelude("foo") +
        "___.deletePub(foo.SIMPLECALL___()," +
        "              bar.SIMPLECALL___());");
    checkSucceeds(
        "delete foo().bar;",
        weldPrelude("foo") +
        "___.deletePub(foo.SIMPLECALL___(), 'bar');");
    assertConsistent(
        "(function() {" +
  ...
  public void testPermittedCall() throws Exception {
    ...
    String fixture =
        ...
        + "  dis: ___.simpleFrozenFunc(function(n) { x = n; })"
        + "});";
    rewriteAndExecute(
        fixture,
        "  $v.dis(42);",
  ...
  public void testFuncNamedSimpleValue() throws Exception {
    ...
    checkSucceeds(
        ...
        "var bar = function() {" +
        "  function foo_(x, y) {" +
        "    return foo_.SIMPLECALL___(x - 1, y - 1);" +
        "  }" +
  ...
  public void testMapNonEmpty() throws Exception {
    checkSucceeds(
        ...
        "    [ 'k0', " + weldReadPub("g.SIMPLECALL___()", "x", "x0___") + ", " +
        "      'k1', " + weldReadPub("g.SIMPLECALL___()", "y", "x1___") + " ]);");
  ...
  protected Object rewriteAndExecute(String pre, String caja, String post)
    ...
    for (String f : assertFunctions) {
      importsSetup
          .append("testImports." + f + " = ___.simpleFunc(" + f + ");")
