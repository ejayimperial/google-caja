...
public class DefaultCajaRewriterTest extends RewriterTestCase {
  ...
  public void testToString() throws Exception {
    ...
    assertConsistent(
        ...
        + "'' + (new foo);");
    rewriteAndExecute(
        "___.setPub(testImports, 'exports', {});",
  ...
  public void testToxicBind() throws Exception {
    rewriteAndExecute(
        "var confused = false;" +
        "___.setPub(testImports, 'keystone', null);" +
  ...
  public void testBadDelete() throws Exception {
    rewriteAndExecute(
        "___.setPub(testImports, 'badContainer', {secret_: 3469});",
