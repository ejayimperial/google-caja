...
public abstract class QuasiNode {
  ...
  public ParseTreeNode substitute(boolean synthetic, Map<String, ParseTreeNode> bindings) {
    List<ParseTreeNode> results = new ArrayList<ParseTreeNode>();
    return (createSubstitutes(synthetic, results, bindings) && results.size() == 1) ? results.get(0) : null;
  }
