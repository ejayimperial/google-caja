...
public abstract class Rule implements MessagePart {
  ...
  protected ParseTreeNode subst(Map<String, ParseTreeNode> bindings) {
    return QuasiBuilder.subst(false, getRuleDescription().substitutes(), bindings);
  }
   ...
   * {@link RuleDescription#substitutes}.
   */
  protected ParseTreeNode subst(boolean synthetic, Map<String, ParseTreeNode> bindings) {
    return QuasiBuilder.subst(synthetic, getRuleDescription().substitutes(), bindings);
  }
