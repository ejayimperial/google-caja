...
public class DefaultCajaRewriterTest extends TestCase {
  ...
  public void testForeach() throws Exception {
    ...
    checkSucceeds(
        ...
        "  for (var k in this) { k; }" +
        "}",
        "7; ___OUTERS___.foo = ___.ctor(function foo() {" +
        "  var t___ = this;" +
        "  {" +
        "    var x0___ = t___;" +
        "    var x1___ = undefined;" +
        ...
        "});");
    checkSucceeds(
        "8; for (var k in this) { k; }",
        "8; {" +
        "  var x0___ = ___OUTERS___;" +
        "  var x1___ = undefined;" +
        "  var k;" +
        "  for (x1___ in x0___) {" +
        "    if (___.canEnumProp(x0___, x1___)) {" +
    ...
    checkSucceeds(
        ...
        "  for (k in this) { k; }" +
        "}",
        "9; ___OUTERS___.foo = ___.ctor(function foo() {" +
        "  var t___ = this;" +
        "  {" +
        "    var x0___ = t___;" +
        "    var x1___ = undefined;" +
    ...
    checkSucceeds(
        ...
        "  for (k in this) { k; }" +
        "}",
        "10; ___OUTERS___.foo = ___.ctor(function foo() {" +
        "  var t___ = this;" +
        "  var k;" +
        "  {" +
        "    var x0___ = t___;" +
    ...
    checkSucceeds(
        ...
        "  for (y.k in this) { y.k; }" +
        "}",
        "11; ___OUTERS___.foo = ___.ctor(function foo() {" +
        "  var t___ = this;" +
        "  {" +
        "    var x0___ = t___;" +
        "    var x1___ = undefined;" +
