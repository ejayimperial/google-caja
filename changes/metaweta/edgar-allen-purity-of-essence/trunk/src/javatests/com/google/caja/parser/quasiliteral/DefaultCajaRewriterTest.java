...
public class DefaultCajaRewriterTest extends CajaTestCase {
  ...
  private static String weldReadOuters(String varName, boolean flag) {
    return
        ...
        "    ___.readPub(___OUTERS___, '" + varName + "', ___POE___" + 
                         (flag ? ", true" : "") + "))";
  }
  ...
  public void testCajaExtend() throws Exception {
    assertConsistent(
        "caja.extend(Object, {x:1});" +
        "({}).x;");
    assertConsistent(
        "caja.extend(Array, {last:function(){ return this[this.length - 1];}});" +
        "([2,4,6]).last();");
  }
  ...
  public void testReadPublic() throws Exception {
    checkSucceeds(
        ...
        weldSetOuters(
            ...
            "  return x___.p_canRead___ ? x___.p : ___.readPub(x___, 'p', ___POE___);" +
            "})()"));
  }
  ...
  public void testReadIndexGlobal() throws Exception {
    checkSucceeds(
        "this[3];",
        "___.readPub(___OUTERS___, 3, ___POE___);");
    checkSucceeds(
        "try { } catch (e) { this[3]; }",
        "try {" +
        "} catch (ex___) {" +
  ...
  public void testReadIndexPublic() throws Exception {
    checkSucceeds(
        ...
        "  function() {" +
        "    var foo;" +
        "    " + weldSetOuters("p", "___.readPub(foo, 3, ___POE___)") +
        "  }" +
        "));");
  }
  ...
  public void testSetMember() throws Exception {
    ...
    checkSucceeds(  // Doesn't trigger setMember but should.
        ...
        "            function () {" +
        "              var x___ = " + weldReadOuters("foo") + ";" +
        "              return x___.bar_canRead___ ? x___.bar : ___.readPub(x___, 'bar', ___POE___);" +
        "            })();" +
        "        return x___.prototype_canRead___ ? x___.prototype : ___.readPub(x___, 'prototype', ___POE___);" +
        "      })();" +
  ...
  public  void testSetDeclare() throws Exception {
    ...
    checkSucceeds(
        "var v;",
        "___.setPub(___OUTERS___, 'v', ___.readPub(___OUTERS___, 'v', ___POE___));");
    checkSucceeds(
        "try { } catch (e) { var v; }",
        "try {" +
        "} catch (ex___) {" +
  ...
  public void testSetReadModifyWriteLocalVar() throws Exception {
    ...
    checkSucceeds(
        ...
        + "  ___.readPub(___OUTERS___, 'x', ___POE___, true) + 1)");
    checkSucceeds(
        "(function (x) { x += 1; })",
    ...
    checkSucceeds(
        ...
        + "                    ___.readPub(x0___, 'key', ___POE___, false) + 1);"
        + "})()");
    checkSucceeds(
        "myArray()[myKey()] += 1",
        "var x0___;"
        ...
        + "                    ___.readPub(x0___, x1___, ___POE___, false) + 1);"
        + "})()");
    checkSucceeds(  // Local reference need not be assigned to a temp.
        ...
        + "                      ___.readPub(x0___, myKey, ___POE___, false) + 1);"
        + "  })()"
        + "}))");
  ...
  public void testSetIncrDecr() throws Exception {
    ...
    checkSucceeds(
        "x++;",
        "(function() {" +
        "  var x___ = ___.readPub(___OUTERS___, 'x', ___POE___, true) - 0;" +
  ...
  public void testSetIncrDecrOfComplexLValues() throws Exception {
    ...
    checkSucceeds(
        ...
        "  var x___ = ___.readPub(x0___, 'x', ___POE___, false) - 0;" +
  ...
  public void testDeleteProp() throws Exception {
    ...
    checkSucceeds("function Ctor() { D.call(this); delete this.foo_; }",
                  ...
                  "            ? ___OUTERS___.D" +
                  "            : ___.readPub(___OUTERS___, 'D', ___POE___, true);" +
                  "        var x0___ = t___;" +
                  "        return x___.call_canCall___" +
                  "            ? x___.call(x0___)" +
                  "            : ___.callPub(x___, 'call', [x0___], ___POE___);" +
                  "      })();" +
  ...
  public void testCallGlobalViaThis() throws Exception {
    checkSucceeds(
        ...
        "      ___.callPub(___OUTERS___, 'f', [x0___, x1___], ___POE___);" +
        "})();");
    checkSucceeds(
  ...
  public void testCallPublic() throws Exception {
    checkSucceeds(
        ...
        "    x___.m(x0___, x1___) :" +
        "    ___.callPub(x___, 'm', [x0___, x1___], ___POE___);" +
        "})();");
  }
  ...
  public void testCallIndexPublic() throws Exception {
    checkSucceeds(
        ...
        "    " + weldReadOuters("x") + ", " +
        "    " + weldReadOuters("y") + ", " +
        "    [" + weldReadOuters("z") + ", " + weldReadOuters("t") + "], ___POE___);");
  }
  ...
  public void testFuncExophoricFunction() throws Exception {
    checkSucceeds(
        ...
        "       return (function () {" +
        "         var x___ = t___;" +
        "         return x___.x_canRead___ ? x___.x : ___.readPub(x___, 'x', ___POE___);" +
        "       })();" +
        "     })"
        );
    checkFails(
  ...
  public void testFuncCtor() throws Exception {
    ...
    checkSucceeds(
        ...
        "          var t___ = this;" +
        "          (___OUTERS___.Foo_canRead___ ? ___OUTERS___.Foo : ___.readPub(___OUTERS___, 'Foo', ___POE___, true)).call(this, 1);" +
        "          (function () {" +
        "              var x___ = y;" +
  ...
  public void testOtherTypeof() throws Exception {
    checkSucceeds("typeof x;", "typeof ___.readPub(___OUTERS___, 'x', ___POE___);");
  ...
  public void testMultiDeclaration() throws Exception {
    ...
    checkSucceeds(
        "var x, y;",
        "___.setPub(___OUTERS___, 'x', ___.readPub(___OUTERS___, 'x', ___POE___)), " +
        "___.setPub(___OUTERS___, 'y', ___.readPub(___OUTERS___, 'y', ___POE___));");
    checkSucceeds(
        "var x = foo, y = bar;",
    ...
    checkSucceeds(
        "for (var x, y; ; ) {}",
        "for (___.setPub(___OUTERS___, 'x', ___.readPub(___OUTERS___, 'x', ___POE___)), " +
        "___.setPub(___OUTERS___, 'y', ___.readPub(___OUTERS___, 'y', ___POE___)); ; ) {}");
    checkSucceeds(
        "for (var x = foo, y = bar; ; ) {}",
  ...
  public void testRecurseLoop() throws Exception {
    checkSucceeds(
        ...
        "     " + weldReadOuters("k") + " < 3;" +
        "     (function () {" +
        "       var x___ = ___.readPub(___OUTERS___, 'k', ___POE___, true) - 0;" +
  ...
  private void assertConsistent(String message, String caja)
    ...
    Object uncajoledResult = RhinoTestBed.runJs(
        ...
        new RhinoTestBed.Input(
            ...
            "  }, " +
            "  extend: function (clazz, members) {" +
            "    for (var m in members) {" +
            "      clazz.prototype[m] = members[m];" +
            "    }" +
            "  }};",
            "caja-stub"),
    ...
    Object cajoledResult = RhinoTestBed.runJs(
        ...
        new RhinoTestBed.Input(
            ...
            "  var ___POE___ = ___.makePOE();\n" +
            "  var extend___ = ___.safeExtend(___POE___);\n" +
               cajoledJs + "\n" +
            "});",
            getName() + "-cajoled"),
