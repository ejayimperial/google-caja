...
public class DefaultCajaRewriter extends Rewriter {
  final public Rule[] cajaRules = {
    ...
    new Rule () {
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("this.@p", node, bindings) && scope.isGlobal()) {
          ...
          return substV(
              "___OUTERS___.@xCanRead ? ___OUTERS___.@x : ___.readPub(___OUTERS___, @xName, ___POE___);",
              "x", bindings.get("p"),
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("@o.@p", node, bindings)) {
          ...
          return substV(
              "(function() {" +
              "  var x___ = @o;" +
              "  return x___.@fp ? x___.@p : ___.readPub(x___, @rp, ___POE___);" +
              "})()",
              "o",  expand(bindings.get("o"), scope, mq),
              "p",  p,
              "fp", new Reference(new Identifier(propertyName + "_canRead___")),
    ...
    new Rule () {
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("this[@s]", node, bindings) && scope.isGlobal()) {
          return substV(
              "___.readPub(___OUTERS___, @s, ___POE___)",
        ...
        if (match("var @v", node, bindings) &&
          ...
          if (!scope.isGlobal()) {
            ...
            ParseTreeNode expr = substV(
                "___.setPub(___OUTERS___, @vName, ___.readPub(___OUTERS___, @vName, ___POE___));",
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("this.@m(@as*)", node, bindings) && scope.isGlobal()) {
          ...
          return substV(
              ...
              "      ___OUTERS___.@m(@vs*) :" +
              "      ___.callPub(___OUTERS___, @rm, [@vs*], ___POE___);" +
              "})()",
              "as", aliases.b,
              "vs", aliases.a,
              "m",  m,
    ...
    new Rule () {
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        Map<String, ParseTreeNode> bindings = new LinkedHashMap<String, ParseTreeNode>();
        if (match("caja.extend(@clazz, @members)", node, bindings)) {
          return substV(
              "extend___(@clazz, @members)",
              "clazz", expand(bindings.get("clazz"), scope, mq),
              "members", expand(bindings.get("members"), scope, mq));
        }
        return NONE;
      }
    },
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("@o.@m(@as*)", node, bindings)) {
          ...
          return substV(
              ...
              "  var x___ = @o;" +
              "  @as*;" +
              "  return x___.@fm ? x___.@m(@vs*) : ___.callPub(x___, @rm, [@vs*], ___POE___);" +
              "})()",
              "o",  expand(bindings.get("o"), scope, mq),
              "as", aliases.b,
              "vs", aliases.a,
    ...
    new Rule () {
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("@o[@s](@as*)", node, bindings)) {
          expandEntries(bindings, scope, mq);
          return subst(
              "___.callPub(@o, @s, [@as*], ___POE___)", bindings);
        }
        return NONE;
      }
    },
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("typeof @f", node, bindings)) {
          ...
          if (f instanceof Reference && scope.isGlobal(getReferenceName(f))) {
            ...
            expand(f, scope, mq);
            return substV(
                "typeof ___.readPub(___OUTERS___, @fname, ___POE___)",
