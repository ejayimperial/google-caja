...
___.primFreeze(wrapmap.mainTest);
___.primFreeze(wrapmap.argTest);
...
___.loadModule(function (___, IMPORTS___) {
{
	...
	document.write("<br /><br /><span class='comment'>The following one"+
			" should succeed.<br/>");
	...
	//document.write(___.callPub(tester,"privateprop",[]));
