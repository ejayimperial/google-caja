...
final class CompileGxpsStage implements Pipeline.Stage<Jobs> {
  private final CssSchema cssSchema;
  private final HtmlSchema htmlSchema;

  CompileGxpsStage(CssSchema cssSchema, HtmlSchema htmlSchema) {
    if (cssSchema == null || htmlSchema == null) {
