...
public class Declaration extends AbstractStatement<Expression> {
  ...
  public Declaration(Object value, List<? extends ParseTreeNode> children) {
    this.children.addAll((List<Expression>)children);
    childrenChanged();
  }

  public Declaration(String identifierName, Expression initializer) {
