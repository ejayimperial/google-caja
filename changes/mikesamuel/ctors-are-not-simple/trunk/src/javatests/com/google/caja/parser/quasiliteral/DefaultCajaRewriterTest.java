...
public class DefaultCajaRewriterTest extends RewriterTestCase {
  ...
  public void testVarBadSuffix() throws Exception {
    ...
    checkSucceeds(
        "function() { var foo_ = 3; }",
        "___.simpleFunc(function() { var foo_ = 3; })");
  }
  ...
  public void testSetReadModifyWriteLocalVar() throws Exception {
    ...
    checkSucceeds(
        "(function (x) { x += 1; })",
        "(___.simpleFunc(function (x) { x = x + 1; }))");
    checkSucceeds(
        "myArray().key += 1",
        "  var x0___;"
  ...
  public void testSetIncrDecrOnLocals() throws Exception {
    ...
    checkSucceeds(
        ...
        "___.simpleFunc(function (x, y) { return [x--, --x, y++, ++y]; })");
  ...
  public void testCallCajaDef3Plus() throws Exception {
    ...
    checkSucceeds(
        ...
        "    s1: ___.simpleFunc(function() { return 3; })" +
        "});");
    checkFails(
        "function() {" +
        "  function Point() {}" +
  ...
  public void testFuncCtor() throws Exception {
    ...
    checkSucceeds(
        ...
        "___.asSimpleFunc(___.simpleFunc(function () {" +
        "    var Foo;" +
        "    var Foo = (function () {" +
        "        ___.splitCtor(Foo, Foo_init___);" +
        "        function Foo(var_args) {" +
