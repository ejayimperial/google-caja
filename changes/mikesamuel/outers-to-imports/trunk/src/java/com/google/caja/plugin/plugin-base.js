 ...
 */
function plugin_dispatchEvent___(event, domNode, moduleId, handler) {
  // TODO: turn event into a capability
  var safeEvent = null;
  var safeNode = null;
  var imports = ___.getImports(moduleId);
  if (domNode && domNode !== window) {
    safeNode = imports.plugin_domNode___(domNode, imports.nsPrefix___);
  }
  try {
...
function initPlugin(IMPORTS___, nsPrefix, rootId, pathPrefix) {
  ...
  function plugin_log___(msg) {
    console && console.log((IMPORTS___.name || '<unknown>') + ' : ' + msg);
  }
  ...
  (function() {
     ...
     */
    IMPORTS___.setTimeout = function (fn, delayMillis) {
     ...
     * set.
     */
    IMPORTS___.clearTimeout = function (id) {
     ...
     */
    IMPORTS___.setInterval = function (fn, delayMillis) {
      if ('function' !== typeof fn) {
        plugin_log___(
     ...
     * set.
     */
    IMPORTS___.clearInterval = function (id) {
   ...
   */
  IMPORTS___.plugin_cssNumber___ = function (num) {
   ...
   *    attribs and plain text.
   */
  IMPORTS___.plugin_cssColor___ = function (color) {
   ...
   */
  IMPORTS___.plugin_cssUri___ = function (uri) {
    uri = plugin_checkUriRelative___(uri);
    if (/[\'\\]/.test(uri)) { uri = 'about:blank'; }
    return 'url(\'' + uri + '\')';
  };

  IMPORTS___.plugin_checkUriRelative___ = plugin_checkUriRelative___;

  IMPORTS___.plugin_prefix___ = plugin_prefix___;

  IMPORTS___.plugin_html___ = plugin_html___;

  IMPORTS___.plugin_htmlAttr___ = plugin_htmlAttr___;
  
  IMPORTS___.plugin_blessHtml___ = plugin_blessHtml___;

  IMPORTS___.plugin_blessCss___ = plugin_blessCss___;

  IMPORTS___.nsPrefix = nsPrefix;
