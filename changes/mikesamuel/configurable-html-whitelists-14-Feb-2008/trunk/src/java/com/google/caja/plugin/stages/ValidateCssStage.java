...
public final class ValidateCssStage implements Pipeline.Stage<Jobs> {
  ...
  public ValidateCssStage(HtmlSchema htmlSchema) {
  ...
  public boolean apply(Jobs jobs) {
    ...
    boolean valid = true;
    CssValidator v = new CssValidator(htmlSchema, jobs.getMessageQueue());
    ...
    for (Job job : jobs.getJobsByType(Job.JobType.CSS)) {
      ...
      valid &= validate(v, rw, job.getRoot().cast(CssTree.class));
    }
