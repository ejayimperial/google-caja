...
function testNextWeekStart() {
  assertEquals(time.date(2006, 1, 24),
               util.nextWeekStart(time.date(2006, 1, 23), WeekDay.TU));

  assertEquals(time.date(2006, 1, 24),
               util.nextWeekStart(time.date(2006, 1, 24), WeekDay.TU));

  assertEquals(time.date(2006, 1, 31),
               util.nextWeekStart(time.date(2006, 1, 25), WeekDay.TU));

  assertEquals(time.date(2006, 1, 23),
               util.nextWeekStart(time.date(2006, 1, 23), WeekDay.MO));

  assertEquals(time.date(2006, 1, 30),
               util.nextWeekStart(time.date(2006, 1, 24), WeekDay.MO));

  assertEquals(time.date(2006, 1, 30),
               util.nextWeekStart(time.date(2006, 1, 25), WeekDay.MO));

  assertEquals(time.date(2006, 2, 6),
               util.nextWeekStart(time.date(2006, 1, 31), WeekDay.MO));
}
