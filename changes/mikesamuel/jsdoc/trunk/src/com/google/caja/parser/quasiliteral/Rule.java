...
public abstract class Rule implements MessagePart {
  ...
  protected final Pair<ParseTreeNode, ParseTreeNode> reuseAll(
  ...
  protected final ParseTreeNode expandMember(
  ...
  protected final ParseTreeNode expandAllMembers(
  ...
  protected final boolean checkMapExpression(
      ParseTreeNode node,
      MessageQueue mq) {
    Map<String, ParseTreeNode> bindings = new LinkedHashMap<String, ParseTreeNode>();
