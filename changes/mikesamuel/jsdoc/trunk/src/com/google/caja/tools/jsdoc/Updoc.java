 ...
 */
public final class Updoc extends AbstractParseTreeNode<Updoc.Run> {
  public List<? extends Run> getRuns() { return children(); }

  Updoc(List<? extends Run> runs) {
  ...
  public TokenConsumer makeRenderer(
    ...
    return new JsPrettyPrinter(out, handler);
  }
  ...
  public static final class Run extends AbstractParseTreeNode<Expression> {
    Run(Expression input, Expression result) {
