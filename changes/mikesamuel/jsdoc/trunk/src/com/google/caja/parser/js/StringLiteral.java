...
public final class StringLiteral extends Literal {
  ...
  public void render(RenderContext rc) {
    ...
    // JSON requires double quotes for all string literals but  in paranoid mode
    // we need to produce output that can be safely embedded in
    ...
    // double quotes.
    char delim = !rc.isParanoid() && rc.asJson() ? '"' : '\'';
    sb.append(delim);
