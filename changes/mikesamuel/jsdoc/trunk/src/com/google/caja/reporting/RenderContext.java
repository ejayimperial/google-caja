...
public class RenderContext {
  ...
  private RenderContext(
      ...
      boolean json, TokenConsumer out) {
  ...
  public RenderContext withAsciiOnly(boolean b) {
    return b != asciiOnly
        ? new RenderContext(msgContext, b, paranoid, json, out)
        : this;
  }
  public RenderContext withParanoid(boolean b) {
    return b != paranoid
        ? new RenderContext(msgContext, asciiOnly, b, json, out)
        : this;
  }
  public RenderContext withJson(boolean b) {
    return b != json
        ? new RenderContext(msgContext, asciiOnly, paranoid, b, out)
        : this;
  }
}
