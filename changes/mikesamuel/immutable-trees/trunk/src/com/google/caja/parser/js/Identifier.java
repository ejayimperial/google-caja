...
import com.google.caja.parser.EmptyParseTreeNode;
 ...
 */
public final class Identifier extends EmptyParseTreeNode {
  private final String name;

  public Identifier(String name, List<ParseTreeNode> children) {
    this(name);
