 ...
 */
public final class SimpleQuasiNode extends QuasiNode {
  ...
  protected boolean createSubstitutes(
    ...
    ParseTreeNode node = ParseTreeNodes.newNodeInstance(clazz, value, children);
    node.getAttributes().set(ParseTreeNode.FILE_POSITION, NULL_FILE_POSITION);
