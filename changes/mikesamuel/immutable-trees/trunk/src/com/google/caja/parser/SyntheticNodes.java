...
public final class SyntheticNodes {
  public static final SyntheticAttributes.Key<Boolean> SYNTHETIC
      = SyntheticAttributes.Key.declare(
          Boolean.class, "synthetic", Boolean.FALSE);

  /**
   * A convenience function used to mark all nodes created by a
   * source->javascript compiler as {@link #SYNTHETIC synthetic}.
   * The only non synthetic
   * nodes in the compiled javascript will be those corresponding to user
   * supplied javascript embedded in the original source.
   * <p>
