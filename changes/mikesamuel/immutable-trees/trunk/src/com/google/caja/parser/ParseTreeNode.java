...
public interface ParseTreeNode extends MessagePart, Renderable, Cloneable {
   ...
   */
  public static final SyntheticAttributes.Key<Boolean> TAINTED
      = SyntheticAttributes.Key.declare(
          Boolean.class, "tainted", Boolean.FALSE);

  /**
   * A synthetic attribute that is used to associated comments with a parsed
   * node.
   */
  public static final SyntheticAttributes.Key<TokenList> COMMENTS
      = SyntheticAttributes.Key.declare(
          TokenList.class, "comments", TokenList.EMPTY);
  /**
   * A synthetic attribute that is used to associated comments with a parsed
   * node.
   */
  public static final SyntheticAttributes.Key<FilePosition> FILE_POSITION
      = SyntheticAttributes.Key.declare(
          FilePosition.class, "fileposition", FilePosition.UNKNOWN);
