...
public final class CssValidator {
   ...
   */
  public static final SyntheticAttributes.Key<Name> CSS_PROPERTY_PART
      = SyntheticAttributes.Key.declare(Name.class, "cssPropertyPart", null);
  /**
   * What type is a term?   A term might be an absolute-size, a uri, etc.
   * @see com.google.caja.parser.css.CssTree.Term
   */
  public static final SyntheticAttributes.Key<CssPropertyPartType>
    CSS_PROPERTY_PART_TYPE = SyntheticAttributes.Key.declare(
        CssPropertyPartType.class, "cssPropertyPartType", null);

  /**
   * Used to mark invalid nodes.  Default to false.
   */
  public static final SyntheticAttributes.Key<Boolean> INVALID
      = SyntheticAttributes.Key.declare(
        Boolean.class, "cssValidator-invalid", Boolean.FALSE);
...
final class SignatureResolver {
  ...
  private static final SyntheticAttributes.Key<Integer> NUM  // HACK: debug
      = SyntheticAttributes.Key.declare(Integer.class, "serialno", null);
  ...
  private static String dump(ParseTreeNode node) {
    ...
    mc.relevantKeys
        = Collections.<SyntheticAttributes.Key<Integer>>singleton(NUM);
    try {
