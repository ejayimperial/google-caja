...
public final class DebuggingSymbolsStage implements Pipeline.Stage<Jobs> {
  ...
  /**
   * @param adds a call to ___.useDebugSymbols to a ___.loadModule call.
   */
...
final class CajaRuntimeRewriter extends Rewriter {
  ...
  abstract class AddPositionParamRule extends Rule {
    ...
    public ParseTreeNode fire(
      ...
      if (bindings != null) {
        System.err.println(node.getFilePosition() + " matched " + getName());
        FilePosition pos = spanningPos(node);
