...
public class DefaultCajaRewriterTest extends RewriterTestCase {
  ...
  public static String weldPrelude(String name) {
    return "var " + name + " = IMPORTS___." + name + ";";
  }
  ...
  public void testDeleteProp() throws Exception {
    // TODO(ihab.awad): This actually throws an xo4a error!
    checkFails(
        "function() { delete this.foo___; };",
        "Properties cannot end in \"__\"");
  ...
  protected void assertConsistent(String caja) throws ParseException, IOException {
    System.err.println("==== assertConsistent ===================================");
    cajole(js(fromString(caja)));
    System.err.println("==== assertConsistent ===================================");
    super.assertConsistent(caja);
  }  
