...
public abstract class AbstractParseTreeNode<T extends ParseTreeNode>
  ...
  // private static final FilePosition NOWHERE = null;

  private static final FilePosition NOWHERE = FilePosition.startOfFile(new InputSource(URI.create("built-in:///nowhere")));
