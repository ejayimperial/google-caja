...
(function(global) {
  ...
  function canRead(obj, name)   { 
    if (!obj) { fail('canRead called with empty target for name: ' + name); }
  ...
  function canEnum(obj, name)   {
    if (!obj) { fail('canEnum called with empty target for name: ' + name); }
  ...
  function canCall(obj, name)   {
    if (!obj) { fail('canCall called with empty target for name: ' + name); }
  ...
  function canSet(obj, name) {
    if (!obj) { fail('canSet called with empty target for name: ' + name); }
  ...
  function canDelete(obj, name) {
    if (!obj) { fail('canDelete called with empty target for name: ' + name); }
