...
public class DefaultGadgetRewriterTest extends TestCase {
  ...
  public void testInlineGadgetBaja() throws Exception {
    rewriter.setTranslationScheme(PluginMeta.TranslationScheme.BAJA);
    assertRewritePasses("listfriends-inline.xml", MessageLevel.WARNING);
  }

  public void testXrefGadgetListfriends() throws Exception {
    assertRewritePasses("listfriends.xml", MessageLevel.WARNING);
  }

  public void testXrefGadgetClickme() throws Exception {
    assertRewritePasses("clickme.xml", MessageLevel.WARNING);
  }
  ...
  public void testParsingBaja() throws Exception {
    rewriter.setTranslationScheme(PluginMeta.TranslationScheme.BAJA);
    assertRewritePasses("test-parsing.xml", MessageLevel.WARNING);    
  }
