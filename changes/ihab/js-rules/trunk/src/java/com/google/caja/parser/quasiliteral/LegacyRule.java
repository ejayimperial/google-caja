...
/**
 * A rewriting rule written explicitly in Java.
 */
public abstract class LegacyRule implements Rule {
   ...
   * @param rewriter the {@link Rewriter} that hosts this rule.
   */
  public LegacyRule(String name, Rewriter rewriter) {
    this.name = name;
