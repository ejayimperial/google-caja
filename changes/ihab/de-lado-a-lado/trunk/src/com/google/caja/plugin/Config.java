...
public final class Config {
  ...
  private final Option SIDE_BY_SIDE_OUTPUT = defineBooleanOption(
      "s",
      "sidebyside",
      "Side by side rendering of original and cajoled code.");
  ...
  private boolean sideBySideOutput;
  ...
  public boolean sideBySideOutput() { return sideBySideOutput; } 
  ...
  public boolean processArguments(String[] argv) {
    try {
      ...
      sideBySideOutput = cl.hasOption(SIDE_BY_SIDE_OUTPUT.getOpt());
