...
public class DefaultGadgetRewriterTest extends TestCase {
  ...
  public static void main(String[] argv) throws Exception {
    new DefaultGadgetRewriterTest().runProfiling();
  }

  private void runProfiling() throws Exception {
    setUp();

    System.out.print("Ready for rewriting test > ");
    System.in.read();

    for (int i = 0; i < 20; i++) testSocialHelloWorld();

    System.out.print("Done with rewriting test > ");
    System.in.read();
