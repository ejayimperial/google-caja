      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("this.@p", node, bindings) && scope.isGlobal()) {
          ...
          return substV(
              ...
              "x", bindings.get("p"),
              "xCanRead", s(new Reference(s(new Identifier(xName + "_canRead___")))),
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("this.@p", node, bindings)) {
          ...
          return substV(
            ...
            "p",  p,
            "fp", s(new Reference(s(new Identifier(propertyName + "_canRead___")))),
        ...
        if (match("@p = @r", node, bindings) &&
          ...
          if (scope.isGlobal(propertyName) && !ReservedNames.THIS.equals(propertyName)) {
            return substV(
                ...
                "p",  p,
                "fp", s(new Reference(s(new Identifier(propertyName + "_canSet___")))),
                "rp", toStringLiteral(p));
          }
        }
        return NONE;
    ...
    new Rule () {
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("this.@p = @r", node, bindings)) {
          ...
          Reference target = s(new Reference(s(new Identifier(
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("@o.@p = @r", node, bindings)) {
          ...
          return substV(
              ...
              "pCanSet", s(new Reference(s(new Identifier(propertyName + "_canSet___")))),
              "p", bindings.get("p"),
      ...
      public ParseTreeNode fire(ParseTreeNode node, Scope scope, MessageQueue mq) {
        ...
        if (match("this.@m(@as*)", node, bindings) && scope.isGlobal()) {
          ...
          return substV(
              ...
              "vs", aliases.a,
              "m",  m,
              "fm", s(new Reference(s(new Identifier(methodName + "_canCall___")))),
