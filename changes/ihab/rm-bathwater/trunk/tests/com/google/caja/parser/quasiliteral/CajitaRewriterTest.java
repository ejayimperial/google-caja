...
public class CajitaRewriterTest extends CommonJsRewriterTestCase {
  ...
  public void testValueOf() throws Exception {
    ...
    // TODO(ihab.awad): Fix the 'caja.def' stuff below!!!
  ...
  public void testCajaPropsFrozen() throws Exception {
    rewriteAndExecute(";","0;",
    "assertTrue(___.isSimpleFunc(___.sharedImports.caja.manifest));");
    rewriteAndExecute(";","0;",
    "assertTrue(___.isFrozen(___.sharedImports.caja.manifest));");
  }
  ...
  public void testForeachBad() throws Exception {
  ...
  public void testNewCallledCtor() throws Exception {
    checkSucceeds(
        "new Date();",
        weldPrelude("Date", "{}")
        + "___.construct(___.asSimpleFunc(Date), []);");
  }
  ...
  public void testFuncNamedSimpleDecl() throws Exception {
    ...
    checkSucceeds(
        ...
        "      x = a___;" +
        "      y = ___.readPub(g, 0);" +
        "      return ___.asSimpleFunc(foo)(x - 1, y - 1);" +
        "  }, 'foo');" +
        "  ;"+
        "});");
    checkSucceeds(
  ...
  public void testFuncNamedSimpleValue() throws Exception {
    ...
    checkSucceeds(
        ...
        "var bar = function() {" +
        "  function foo_(x, y) {" +
        "    return ___.asSimpleFunc(foo_)(x - 1, y - 1);" +
        "  }" +
