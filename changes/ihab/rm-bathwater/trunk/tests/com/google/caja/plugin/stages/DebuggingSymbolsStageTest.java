...
public class DebuggingSymbolsStageTest extends CajaTestCase {
  ...
  public void testCallUndefinedMethod() throws Exception {
    assertStackTrace(
        ...
        + "testCallUndefinedMethod:3+27 - 35\n"
  ...
  public void testInaccessibleProperty() throws Exception {
    assertStackTrace(
        ...
        "testInaccessibleProperty:3+5 - 13\n"
  ...
  public void testConstruction() throws Exception {
    assertStackTrace(
        "var foo = function() { throw 5; };\n"
        //                      ^^^^^^^
        + "new foo();",

        "testConstruction:1+24 - 30");
  }
  ...
  private void assertConsistent(String js) throws Exception {
    // Execute js in the presence of caja so it can use Caja symbols.
