...
attachDocumentStub = (function () {
  ...
  function attachDocumentStub(idSuffix, uriCallback, imports) {
    ...
    ___.simpleFunc(TameCommentNode);
    ...
    ___.simpleFunc(TameFormElement);
    ...
    ___.simpleFunc(TameInputElement);
    ...
    ___.simpleFunc(TameImageElement);
