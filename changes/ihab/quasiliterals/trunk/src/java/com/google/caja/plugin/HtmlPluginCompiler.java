    ...
    if (meta.isBaja) {
      ...
      this.jsTree = s(new Block(
                        Arrays.<Statement>asList(
                            // the private plugin
                            s(new Declaration(
                                new Identifier(meta.namespacePrivateName), pluginPrivate)),
                            // the plugin namespace
                            s(new Declaration(
                                new Identifier(meta.namespaceName), pluginNamespace)),
                            s(new ExpressionStmt(s(new Operation(
                                Operator.ASSIGN,
                                s(new Operation(
                                    Operator.MEMBER_ACCESS,
                                    s(new Reference(new Identifier(meta.namespacePrivateName))),
                                    s(new Reference(new Identifier("plugin"))))),
                                s(new Reference(new Identifier(meta.namespaceName)))
                                )))),
                            s(new ExpressionStmt(s(new Operation(
                                Operator.FUNCTION_CALL,
                                s(new Reference(new Identifier("plugin_initialize___"))),
                                s(new Reference(new Identifier(meta.namespacePrivateName)))))))
                        )));
    }
    ...
    try {
      ...
      Expression templateRef = s(
          new Operation(
              Operator.MEMBER_ACCESS,
              s(new Reference(new Identifier(meta.namespacePrivateName))),
              s(new Reference(new Identifier(job.sig.getAssignedName())))));
                      ...
                      s(new Operation(
                          ...
                          s(new Operation(
                              ...
                              s(new Operation(
                                  Operator.MEMBER_ACCESS,
                                  s(new Reference(new Identifier(meta.namespaceName))),
                                  s(new Reference(new Identifier("document"))))),
                                  s(new Reference(new Identifier("write"))))),
                                  s(new Operation(
                                      Operator.FUNCTION_CALL,
                                      s(new Operation(
                                          Operator.MEMBER_ACCESS,
                ...
                s(new Operation(
                    ...
                    s(new Operation(
                        ...
                        s(new FunctionConstructor(
                            new Identifier(null), Collections.<FormalParam>emptyList(),
                            functionBody)),
          ...
          new ExpressionStmt(
              s(new Operation(
                    ...
                    s(new Operation(
                        Operator.MEMBER_ACCESS,
                        s(new Reference(new Identifier(meta.namespaceName))),
                        s(new Reference(new Identifier(d.getIdentifierName()))))),
                    initializer))));
      ...
      public boolean visit(ParseTreeNode node) {
        ...
        if (node instanceof Reference) {
          ...
          if (!locals.contains(ref.getIdentifierName())
            ...
            Reference placeholder = new Reference(new Identifier("_"));
