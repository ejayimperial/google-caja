...
public class Reference extends AbstractExpression<Expression> {
  ...
  public Reference(Void value, List<Expression> children) {
  ...
  public boolean isArguments() {
    return this.getIdentifierName().equals(ReservedNames.ARGUMENTS)
      || this.getIdentifierName().equals(ReservedNames.LOCAL_ARGUMENTS);
  }
}
