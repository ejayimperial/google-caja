function (___, cajita, document, navigator) {
  /**
  ...
  var bridal = load('bridal.js')({
    document: document,
    navigator: navigator
  });
  var classUtils = load('classUtils.js')({
    ___: ___
  });
  var TameNode = load('TameNode.js')({
    ___: ___,
    cajita: cajita,
    classUtils: classUtils
  });
  var TameElement = load('TameElement.js')({
    classUtils: classUtils,
    bridal: bridal,
    TameNode: TameNode,
    html4: html4,
    cssSealerUnsealerPair: cssSealerUnsealerPair
  });
  ...
  function attachDocumentStub(idSuffix, uriCallback, imports) {
    ...
    var htmlBlessing = load('htmlBlessing.js')(html);
    imports.blessHtml___ = htmlBlessing.blessHtml;
    imports.html___ = htmlBlessing.safeHtml;
