...
public abstract class AbstractParseTreeNode<T extends ParseTreeNode>
   ...
   *
   * <pre>ctor(Object value, List&lt;? extends ParseTreeNode&gt; children)</pre>
   *
  ...
  public static ParseTreeNode newNodeInstance(
    ...
    try {
      ctor = clazz.getConstructor(Object.class, List.class);
  ...
  public ParseTreeNode clone() {
    List<ParseTreeNode> cloneChildren = new ArrayList<ParseTreeNode>();
    for (ParseTreeNode child : children) cloneChildren.add(child.clone());
