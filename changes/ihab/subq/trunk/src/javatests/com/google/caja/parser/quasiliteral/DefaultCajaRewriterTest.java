...
public class DefaultCajaRewriterTest extends RewriterTestCase {
  ...
  public void testParse() throws Exception {
    ParseTreeNode n = js(fromString("this.foo(bar);"));
    Map<String, ParseTreeNode> m = new HashMap<String, ParseTreeNode>();
    boolean matched = QuasiBuilder.match("{ this.@x(@arg); }", n, m);
    System.out.println("matched = " + matched);
    StringBuilder out = new StringBuilder();
    n.format(new MessageContext(), out);
    System.out.println(out);
  }

  public void testDuplicateTempVariables() throws Exception {
    wartsMode = true;
    cajole(js(fromString("var obj = {i:0, m:function() {return this.i;}};")));
  }
  ...
  public void testAssignToFunctionName() throws Exception {
    cajole(js(fromString(
        "  function foo() {}"
        + "foo = 3;")));
  }
