...
public class HtmlCompiledPluginTest extends TestCase {
  ...
  public void testStaticsAreSettable() throws Exception {
    execGadget(
      "<script type=\"text/javascript\">\n"+
      "function Point(x,y) {\n"+
      "  this.x_ = x;\n"+
    ...
    execGadget(
        "<script type=\"text/javascript\">\n" +
            ...
            "    this.y_ = y;\n" +
            "  }\n" +
            "  Point.prototype.toString = function() { return '<'+this.x_+','+this.y_+'>'; };\n" +
  ...
  public void testFunctionWithUnderscore() throws Exception {
    execGadget(
        "<script type=\"text/javascript\">\n" +
            "function f_() {}\n" +
            "f_();\n" +
