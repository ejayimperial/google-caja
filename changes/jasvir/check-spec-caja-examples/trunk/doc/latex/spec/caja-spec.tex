...
% TODO(erights): ``stereotyped'' is the wrong word
  \TODO{erights}{Replace ``stereotyped'' with the right word}
...
failures of excess authority.\TODO{all}{Clarify this last sentence}
...
\begin{figure}[t!]
\begin{cajita}{cajita-point-mixin}
...
\begin{figure}[t!]
\begin{cajita}{cajita-wobbly-point-mixin}
...
%
\begin{caja}{caja-foreach}caja.forEach(obj,function(v,k)\{{\ldots}\});\end{caja}
%
...
\begin{description}
    ...
    \TODO{erights}{Explain elsewhere}
...
\begin{description}
  ...
  following instead:
%
\begin{caja}{caja-bareloop-gotcha}
for (var k in obj)\ \{ 
...
\begin{figure}[t!]
\begin{caja}{caja-inner-method-gotcha}
