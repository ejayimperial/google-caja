...
public final class Config {
  ...
  public void setInputUris(String input) 
    throws FileNotFoundException, URISyntaxException {
      ...
      if (input.indexOf(':') >= 0) {
        ...
        if (!inputFile.isFile()) {
          throw new FileNotFoundException ( "File \"" + input + "\" is not a regular file");
        }
  ...
  public void setOutputBase(String outputBaseName) {
    this.outputBase = new File ( outputBaseName );
  }
  
  public void setOutputJsFile(String outputJsFileName) {
    this.outputJsFile = new File ( outputJsFileName );
  }

  public void setOutputCssFile(String outputCssFileName) {
    this.outputCssFile = new File ( outputCssFileName );
  }
  
  public void setCssPrefix(String cssPrefixString) throws URISyntaxException {
    cssPrefix = cssPrefixString;
    cssPropertyWhitelistUri = 
      new URI("resource:///com/google/caja/lang/css/css21.json");
    htmlAttributeWhitelistUri = 
      new URI("resource:///com/google/caja/lang/html/html4-attributes.json");
    htmlElementWhitelistUri = 
      new URI("resource:///com/google/caja/lang/html/html4-elements.json");
  }
}
