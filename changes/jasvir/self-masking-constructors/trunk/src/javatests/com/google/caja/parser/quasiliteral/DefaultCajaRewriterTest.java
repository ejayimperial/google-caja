...
public class DefaultCajaRewriterTest extends TestCase {
  ...
  public void testMaskingFunction () throws Exception {
    checkFails(
        ...
        "Goo originally defined at built-in:///js-test:1+16");
    checkFails(
        "function Goo() { var Goo = 1; }",
        "Goo originally defined at built-in:///js-test:1+16");
    checkSucceeds(
        "function Goo() { this.x=3; }",
        "(function () {" +
        "    var x___ = (function () {" +
        "        ___.splitCtor(Goo, Goo_init___);" +
        "        function Goo(var_args) {" +
        "          return new Goo.make___(arguments);" +
        "        }" +
        "        function Goo_init___() {" +
        "          var t___ = this;" +
        "          (function () {" +
        "              var x___ = 3;" +
        "              return t___.x_canSet___ ? (t___.x = x___) : ___.setProp(t___, 'x', x___);" +
        "            })();" +
        "        }" +
        "        return Goo;" +
        "      })();" +
        "    return ___OUTERS___.Goo_canSet___ ? (___OUTERS___.Goo = x___) : ___.setPub(___OUTERS___, 'Goo', x___);" +
        "  })();");
  }
