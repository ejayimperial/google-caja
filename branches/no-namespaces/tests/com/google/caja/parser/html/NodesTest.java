  ...
  public final void testRenderOfEmbeddedXml() throws Exception {
    assertEquals(
        ...
        Nodes.render(xmlFragment(fromString(
            "<td width='10'><svg:Rect width='50'/></td>")), false));
    assertEquals(
        "<td width=\"10\"><svg:Rect width=\"50\" /></td>",
        Nodes.render(xmlFragment(fromString(
            "<td width='10'><svg:Rect width='50'/></td>")), true));
  }

  public final void testNoSneakyNamespaceDecls1() throws Exception {
    Document doc = DomParser.makeDocument(null, null);
    Element el = doc.createElement("svg:span");
    el.appendChild(doc.createElement("svg:br"));
    String rendered;
    try {
      rendered = Nodes.render(el, true);
